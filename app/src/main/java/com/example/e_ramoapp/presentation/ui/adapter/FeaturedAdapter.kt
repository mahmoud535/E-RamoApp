...
class FeaturedAdapter (private val imageList: List<ImageItem>) : RecyclerView.Adapter<FeaturedAdapter.ImageDealsViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ImageDealsViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_featured_deals, parent, false)
    ...
    class ImageDealsViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        private val imageView: ImageView = itemView.findViewById(R.id.iv_item_featured_image)
